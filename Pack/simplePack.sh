...
SIGNING_IDENTITY="iPhone Distribution: Jiangxi Expressway Investment Group Co., Ltd."
PROVISIONING_PROFILE="$ABS_DIR/../ProvisioningProfiles/BossenInHouseProvisioningProfile.mobileprovision" #com.bsyy.2
...
CONFIG_PLIST_FILE="$WORKSPACE/Payload_`printf "%2d" $seq | tr " " 0`/Payload/${PROJECT_APP_NAME}/ChannelNo.plist"
...
echo "Package $MIN_PKG_NO successfully!"
fi
...
# say "包已经打好了！包已经打好了！包已经打好了！包已经打好了！包已经打好了！"
