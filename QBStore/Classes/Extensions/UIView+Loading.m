...
//    }
//    
//    SVProgressHUD *progressHud = [[SVProgressHUD alloc] initWithView:self];
...
- (void)beginLoading {
    ...
    self.ypb_loadingView.frame = self.bounds;
    self.ypb_loadingView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
...
- (BOOL)isInLoading {
    return [self.subviews containsObject:self.ypb_loadingView];
}
